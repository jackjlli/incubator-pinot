...
public class PinotLLCRealtimeSegmentManagerTest {
  ...
  private void testSetupNewTable(TableConfig tableConfig, IdealState idealState, int nPartitions, int nReplicas,
    ...
    FakePinotLLCRealtimeSegmentManager segmentManager = new FakePinotLLCRealtimeSegmentManager(_mockPinotHelixResourceManager,null);
  ...
  public void testCommitSegmentWhenControllerWentThroughGC()
    ...
    FakePinotLLCRealtimeSegmentManager segmentManager1 = new FakePinotLLCRealtimeSegmentManager(_mockPinotHelixResourceManager, null);
    FakePinotLLCRealtimeSegmentManager segmentManager2 = new FakePinotLLCRealtimeSegmentManagerII(_mockPinotHelixResourceManager, null,
        FakePinotLLCRealtimeSegmentManagerII.SCENARIO_1_ZK_VERSION_NUM_HAS_CHANGE);
    FakePinotLLCRealtimeSegmentManager segmentManager3 = new FakePinotLLCRealtimeSegmentManagerII(_mockPinotHelixResourceManager, null,
  ...
  static class FakePinotLLCRealtimeSegmentManager extends PinotLLCRealtimeSegmentManager {
    ...
    protected FakePinotLLCRealtimeSegmentManager(PinotHelixResourceManager pinotHelixResourceManager, List<String> existingLLCSegments) {
      super(pinotHelixResourceManager, CONTROLLER_CONF, new ControllerMetrics(new MetricsRegistry()), new ControllerLeadershipManager(pinotHelixResourceManager.getHelixZkManager()));
  ...
  static class FakePinotLLCRealtimeSegmentManagerII extends FakePinotLLCRealtimeSegmentManager {
    ...
    FakePinotLLCRealtimeSegmentManagerII(PinotHelixResourceManager pinotHelixResourceManager, List<String> existingLLCSegments, int scenario) {
